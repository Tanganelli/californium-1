...
public class ClusteringTest {
	...
	public void test() throws Throwable {
		try {
			testNotification();
			testNotificationWithBlockWise();
			testCancellingNotification();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void testNotificationWithBlockWise() throws Exception {
	...
	private void testCancellingNotification() throws Exception {
		System.out.println("\nObserve:");
		respPayload = generatePayload(10);
		String path = "test";
		server = createLockstepEndpoint();

 ...
 */
public class ObserveRelationImpl implements ObserveRelation{

	/** The logger. */
	private final static Logger LOGGER = Logger.getLogger(ObserveRelationImpl.class.getCanonicalName());
	 ...
	 */
	public ObserveRelationImpl(ObservingEndpoint endpoint, Resource resource, Exchange exchange) {
		if (endpoint == null)
